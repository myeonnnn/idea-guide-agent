...
스타트업 아이디어를 실제로 개발하기 전에, **이 아이디어를 만들 만한지 판단하고 다음에 무엇을 해야 할지 정리해주는 로컬 AI 도구**입니다.

아이디어 하나를 입력하면 AI가 다음 8단계를 순서대로 진행합니다.

> **타겟층 → 시장조사 → 가치제안 → 가설 수립 → 가설 검증 → MVP/MLP 정의 → 비즈니스모델 → 종합 판단**

최종 결과물은 완성된 사업계획서가 아니라, **무엇을 만들지 말지 결정하기 위한 검증 초안**입니다.
...
* 가장 위험한 가정은 무엇인지
* 다음에 무엇을 검증해야 하는지
* 지금 단계에서 진행 / 피벗 / 보류 중 무엇이 합리적인지

를 판단하는 데 사용할 수 있는 **의사결정용 초안**을 만드는 것이 목적입니다.
...
마지막 단계에서는 앞의 7단계 결과를 다시 한 번 모아서 전체적인 관점에서 **진행 / 피벗 / 보류**를 판단합니다.
